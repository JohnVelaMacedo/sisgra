    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-md-1"><a href="reporteFacultadexcel" target="_blank"><img src="assets/img/excIcon.png" height="40" width="40"></a></div>
...
export default {
    data() {
        return {
            ...
            columns: ["DNI","escuela","Nombre","Telefono","Correo","Ingreso","egreso","AnioBachiller","AnioTitulo"],
            options: {
                    headings:
                    {
                        DNI: "DNI",
